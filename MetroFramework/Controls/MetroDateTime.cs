...
namespace MetroFramework.Controls
{
    ...
    public class MetroDateTime : DateTimePicker, IMetroControl
    {
        ...
        protected virtual void OnPaintForeground(PaintEventArgs e)
        {
            ...
            //TextRenderer.DrawText(e.Graphics, Text, MetroFonts.DateTime(11f), textRect, foreColor, TextFormatFlags.Left | TextFormatFlags.VerticalCenter);
        ...
        public override Size GetPreferredSize(Size proposedSize)
        {
            ...
            using (var g = CreateGraphics())
            {
                ...
                //preferredSize = TextRenderer.MeasureText(g, measureText, MetroFonts.DateTime(11f), proposedSize, TextFormatFlags.Left | TextFormatFlags.LeftAndRightPadding | TextFormatFlags.VerticalCenter);
